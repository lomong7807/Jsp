...
<main>
    <div class="slider">
        ...
        <div class="banner">
            <img src="./images/main_banner_txt.png" dao.selecetLatestalt="GRAND OPEN"/>
    ...
    <div class="quick">
        <a href="/Farmstory1/board/list.jsp?group=Community&cate=menu&pg=1"><img src="./images/main_banner_sub1_tit.png" alt="오늘의 식단"></a>
        <a href="/Farmstory1/board/list.jsp?group=Community&cate=chef&pg=1"><img src="./images/main_banner_sub2_tit.png" alt="나도 요리사"></a>                
    </div>

    <div class="latest">
        <div>
            <a href="/Farmstory1/board/list.jsp?group=Croptalk&cate=grow&pg=1"><img src="./images/main_latest1_tit.png" alt="텃밭 가꾸기"/></a>
        ...
        <div>
            <a href="/Farmstory1/board/list.jsp?group=Croptalk&cate=school&pg=1"><img src="./images/main_latest2_tit.png" alt="귀농학교"/></a>
        ...
        <div>
            <a href="/Farmstory1/board/list.jsp?group=Croptalk&cate=story&pg=1"><img src="./images/main_latest3_tit.png" alt="농작물 이야기"/></a>
    ...
    <div class="info">
        <div>
            ...
            <div class="btns">
                <a href="/Farmstory1/board/list.jsp?group=Community&cate=qna&pg=1"><img src="./images/main_sub2_cs_bt1.png" alt="1:1 고객문의"></a>
                <a href="/Farmstory1/board/list.jsp?group=Community&cate=faq&pg=1"><img src="./images/main_sub2_cs_bt2.png" alt="자주묻는질문"></a>
